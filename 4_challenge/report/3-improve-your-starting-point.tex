...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{Total Validation Cost Comparison.jpg}
    \caption{Total validation cost comparison between base TCN and TCN with de improvement strategies.}
    \label{fig:Total Validation Cost Comparison}
\end{figure}

So we decided on the mentioned combination for our final model. This model now yields an unbiased cost estimate on the test dataset of 41.0388.
