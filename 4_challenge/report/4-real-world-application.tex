...
The question of whether our system could be deployed in a real-world application is hard to answer in general and depends heavily on the specific use case. However, generally speaking, in our opinion, the current version of our system cannot be used as-is in a real world setting. This is primarily due to three reasons:
